<div class="container">
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
        <div class="col mb-3">
            <a href="http://192.0.0.2:8081" class="d-flex align-items-center mb-3 link-body-emphasis text-decoration-none">
        ...
        <div class="col mb-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="http://192.0.0.2:8081" class="nav-link p-0 text-light">Home</a></li>
